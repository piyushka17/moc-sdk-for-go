...
type Service interface {
	...
	Precheck(ctx context.Context, location string, pips []*network.PublicIPAddress) (bool, error)
}
...
func (c *PublicIPAddressAgentClient) Get(ctx context.Context, location, name string) (*[]network.PublicIPAddress, error) {
	return c.internal.Get(ctx, location, name)
}

// Ensure methods invokes create or update on the client
func (c *PublicIPAddressAgentClient) CreateOrUpdate(ctx context.Context, location, name string, pip *network.PublicIPAddress) (*network.PublicIPAddress, error) {
	return c.internal.CreateOrUpdate(ctx, location, name, pip)
}

// Delete methods invokes delete of the network resource
func (c *PublicIPAddressAgentClient) Delete(ctx context.Context, location, name string) error {
...
func (c *PublicIPAddressAgentClient) Precheck(ctx context.Context, location string, pip []*network.PublicIPAddress) (bool, error) {
	return c.internal.Precheck(ctx, location, pip)
}
